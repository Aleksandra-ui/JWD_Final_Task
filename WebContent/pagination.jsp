...
<c:set var="sortCol" value="${empty param.sortColumn ? '' : (param.sortColumn eq 'name' ? 'sortColumn=name' : 'sortColumn=id') }"/>
<c:if test='${not empty sortCol }'><c:set var="sortLine" value="&${sortCol }"/></c:if>
