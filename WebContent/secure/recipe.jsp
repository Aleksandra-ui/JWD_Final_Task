<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="com.epam.jwd.apotheca.controller.action.RecipeDrugs" %>
...
<html>
	...
	<script type="text/javascript">
		...
		function updateRecipeCart( drugId, add ) {
			...
			//function that is called when uploading has finished
