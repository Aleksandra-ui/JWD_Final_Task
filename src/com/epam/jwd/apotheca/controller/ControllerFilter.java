...
public class ControllerFilter implements Filter {
    ...
    public ControllerFilter() {
    	...
    	actionMapping.put("addToCart", AddToCart.getInstance());
    	actionMapping.put("removeFromCart", RemoveFromCart.getInstance());
    	actionMapping.put("displayCart", DisplayCart.getInstance());
    	actionMapping.put("addToRecipeCart", AddToRecipeCart.getInstance());    
    	actionMapping.put("removeFromRecipeCart", RemoveFromRecipeCart.getInstance());
    	actionMapping.put("displayRecipeCart", DisplayRecipeCart.getInstance());
    	actionMapping.put("deleteUser", DeleteUser.getInstance());
